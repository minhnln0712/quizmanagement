        ...
        try {
            ...
            if (!role.isEmpty()) {
                ...
                if (role.equals("Admin")) {
                    Hlist = Hdao.searchHistorywithPaging(subject, pageNo, pagingSize);
                    SumofRow = Hdao.getTotalOfHistoryAfterSearch(subject);
                } else if (role.equals("Student")) {
                    String email = (String) session.getAttribute("EMAIL");
                    Hlist = Hdao.searchHistorywithPagingbyStudent(subject, pageNo, pagingSize, email);
                    SumofRow = Hdao.getTotalOfHistoryAfterSearchbyStudent(subject, email);
                }
                //Xử lý về số trang
                ...
                url = HISTORY_PAGE;
                request.setAttribute("SUBJECTSEARCH", subject);
